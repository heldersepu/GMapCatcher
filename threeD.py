...
class threeD():
    ...
    def show(self):
        ...
        g('set ylabel "Longitude"')
        g('set zlabel "Depth"')
        g('set title "Bathymetry of Scanned Area"')
        g('set ytics -122.03, .001, -122.01')
        g('set xtics 36.94, .0005, 36.97')
        g('set nokey')
        g('splot "new_file.dat" u 1:2:3 with lines')		
